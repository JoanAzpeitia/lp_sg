...
class NukeQuickDailies(tank.platform.Application):
    ...
    def create_daily_v1(self, group_node):
        ...
        nuke.message("Your QT is succesfully added into your shot path, inside elements/precomp_quicktimes."
                     " Remember you can click on Shotgun tab, jump to file system, to get there easily.")
