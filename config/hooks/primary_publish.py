...
class PrimaryPublishHook(Hook):
    ...
    def _do_maya_publish(
        ...
        # save maya publish from script_path
        # define publish path and publish name
        a = os.path.splitext(scene_path)
        publish_path = a[0] + "_published_version" + a[1]
        b = os.path.split(publish_path)
        publish_name = b[1]
    ...
    def _do_nuke_publish(
        ...
        # save nuke publish from script_path
        # define publish path and publish name
        a = os.path.splitext(script_path)
        publish_path = a[0] + "_published_version" + a[1]
        b = os.path.split(publish_path)
        publish_name = b[1]
